  ...
  { src: gallery7, caption: "Lecture" },
   ...
   { src: gallery18, caption: "Team 1" },
    { src: gallery17, caption: "Team 2" },
     ...
     { src: gallery14, caption: "Team 5" },
     { src: gallery13, caption: "Team 6 " },
     { src: gallery12, caption: "Team 7" },
     { src: gallery10, caption: "Team 8" },
     { src: gallery9, caption: "Team 9" },
  { src: gallery8, caption: "Team 10" },
  ...
  <section id="gallery" className="py-5">
    <Container>
      ...
      <h2 className="text-center fw-bold mb-5 gallery-heading">
        <span className="text-warning"><u>EUREKA-2K25</u></span>
